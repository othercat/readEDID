...
int modeDiskAll(BLContextPtr context, struct clarg actargs[klast]);
int modeBootDisk(BLContextPtr context, struct clarg actargs[klast]);
int modeDiskSMART(BLContextPtr context, struct clarg actargs[klast]);
int modeDiskSMARTWithKey(BLContextPtr context, struct clarg actargs[klast]);
int modeBootDiskHours(BLContextPtr context, struct clarg actargs[klast]);
